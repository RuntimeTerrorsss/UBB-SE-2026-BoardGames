        ...
        public static void Initialize()
        {
            ...
            try
            {
                ...
                if (!context.Users.Any(user => user.Username == "henry_08"))
                {
                    ...
                    var alice = new User { Username = "alice99", DisplayName = "Alice", Email = "alice@example.com", PasswordHash = "hash1", PhoneNumber = "0711111111", AvatarUrl = "https://i.pravatar.cc/150?u=alice", Balance = 150.00m, StreetName = "Aleea Godeanu", StreetNumber = "23-25", City = "Cluj-Napoca", Country = "Romania", CreatedAt = DateTime.UtcNow };
                    var bob = new User { Username = "bobby_b", DisplayName = "Bob", Email = "bob@example.com", PasswordHash = "hash2", PhoneNumber = "0722222222", AvatarUrl = "hamster.jpg", Balance = 75.50m, StreetName = "Dorobantilor", StreetNumber = "27", City = "Oradea", Country = "Romania", CreatedAt = DateTime.UtcNow };
                    var carol = new User { Username = "carol_xo", DisplayName = "Carol", Email = "carol@example.com", PasswordHash = "hash3", PhoneNumber = "0733333333", AvatarUrl = "carol.jpg", Balance = 200.00m, StreetName = "Nicolae Titulescu", StreetNumber = "26", City = "Bucuresti", Country = "Romania", CreatedAt = DateTime.UtcNow };
                    var david = new User { Username = "dan_the_m", DisplayName = "Dan", Email = "david@example.com", PasswordHash = "hash4", PhoneNumber = "0744444444", AvatarUrl = "https://i.pravatar.cc/150?u=dan", Balance = 50.00m, StreetName = "Bulevardul Eroilor", StreetNumber = "4", City = "Timisoara", Country = "Romania", CreatedAt = DateTime.UtcNow };
                    var emma = new User { Username = "eva_plays", DisplayName = "Eva", Email = "emma@example.com", PasswordHash = "hash5", PhoneNumber = "0755555555", AvatarUrl = "https://i.pravatar.cc/150?u=eva", Balance = 320.00m, StreetName = "Strada Pacurari", StreetNumber = "88", City = "Iasi", Country = "Romania", CreatedAt = DateTime.UtcNow };
                    var frank = new User { Username = "frank_06", DisplayName = "Frank", Email = "frank@example.com", PasswordHash = "hash6", PhoneNumber = "0766666666", AvatarUrl = "https://i.pravatar.cc/150?u=frank", Balance = 10.00m, StreetName = "Sunset Blvd", StreetNumber = "45", City = "Timisoara", Country = "Romania", CreatedAt = DateTime.UtcNow };
                    var grace = new User { Username = "grace_07", DisplayName = "Grace", Email = "grace@example.com", PasswordHash = "hash7", PhoneNumber = "0777777777", AvatarUrl = "https://i.pravatar.cc/150?u=grace", Balance = 500.00m, StreetName = "Hill Road", StreetNumber = "3", City = "Iasi", Country = "Romania", CreatedAt = DateTime.UtcNow };
                    var henry = new User { Username = "henry_08", DisplayName = "Henry", Email = "henry@example.com", PasswordHash = "hash8", PhoneNumber = "0788888888", AvatarUrl = "https://i.pravatar.cc/150?u=henry", Balance = 0.00m, StreetName = "Lake Street", StreetNumber = "19", City = "Brasov", Country = "Romania", CreatedAt = DateTime.UtcNow };
