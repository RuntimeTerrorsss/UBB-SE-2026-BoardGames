...
namespace BoardGames.Desktop.Views
{
    public sealed partial class ListingsPage : Page
    {
        ...
        private void EditGameButton_Click(object sender, RoutedEventArgs routedEventArgs)
        {
            ...
            var gameToEdit = clickedButton?.Tag as GameSummaryDTO;
            ...
            {
                var gameSummaryToEdit = clickedButton?.Tag as GameSummaryDTO;
                if (gameSummaryToEdit != null)
                {
                    this.Frame.Navigate(typeof(EditGameView), gameSummaryToEdit.Id);
                }
            }
        }
